...
OUT_GLB = OUT_DIR / "metahuman-static-test.glb"
OUT_REPORT = OUT_DIR / "metahuman-static-test.json"
...
def main() -> None:
    ...
    for name, value in (
        ...
        try:
            ...
            unreal.log(f"[MetaHumanStaticGLBExport] skip option {name}: {exc}")
    ...
    unreal.log(f"[MetaHumanStaticGLBExport] wrote {OUT_REPORT}")
    unreal.SystemLibrary.quit_editor()
